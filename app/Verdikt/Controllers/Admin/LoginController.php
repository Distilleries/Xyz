...
use Verdikt\Controllers\AdminBaseController;
use Verdikt\Controllers\AdminModelBaseController;
use Verdikt\Events\UserEvent;
use Verdikt\Formatter\Message;
...
class LoginController extends AdminModelBaseController {
    ...
    protected $layout = 'admin.layout.login';
    ...
    public function getIndex()
    {
        ...
        $form = FormBuilder::create('Verdikt\Forms\Login\SignIn', [
            'class' => 'login-form'
        ]);

        $content = View::make('admin.login.signin', [
            'form' => $form
        ]);
    ...
    public function postIndex()
    {
        ...
        } else
        {
            ...
            return Redirect::back()->with(Message::WARNING, [Lang::get('login.credential')]);
        }
    ...
    public function getRemind()
    {
        ...
        $form = FormBuilder::create('Verdikt\Forms\Login\Forgotten', [
            'class' => 'login-form'
        ]);

        $content = View::make('admin.login.forgot', [
            'form' => $form
        ]);
    ...
    public function getReset($account=null,$token = null)
    {
        ...
        $form = FormBuilder::create('Verdikt\Forms\Login\Reset', [
            'class' => 'login-form'
        ],[
            'token' => $token,
            'account' => $account
        ...
        $content = View::make('admin.login.reset', [
            'form' => $form
        ]);
